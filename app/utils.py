                    ...
                    if current_page == 1:
                        ...
                        if current_page == 1:
                            ...
                            if clean.lower().endswith('k'):
                                ...
                                num = int(float(clean)) if clean else 0
...
def generate_cover_image(title, author, cover_path, chapter_word_counts=None):
    ...
    try:
        ...
        if word_count_str:
            ...
            draw.text((x, current_y), word_count_str, fill=text_color, font=count_font)
...
def create_epub_file(story_title, story_author, story_content, output_directory, cover_image_path=None, story_category=None, story_tags=None, description_text=None, chapter_word_counts=None):
    ...
    try:
        ...
        if cover_image_path is None:
            ...
            generate_cover_image(story_title, story_author, cover_image_path, chapter_word_counts)
